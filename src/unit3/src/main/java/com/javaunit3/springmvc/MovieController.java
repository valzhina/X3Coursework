...
public class MovieController {
    ...
    public String addMovieHandleForm(HttpServletRequest request, Model model) {

        String movieTitle = request.getParameter("movieTitle");
        String maturityRating = request.getParameter("maturityRating");
        String genre = request.getParameter("genre");

//        MovieEntity movieEntity = new MovieEntity(movieTitle, maturityRating, genre);
//        System.out.println(movieEntity);
//
//        SessionFactory factory = new HibernateConfig().getFactory();
